...
$client->setClientId('147756455944-6pa63dn4s4nf7a8t31u3ps56rq7fnncm.apps.googleusercontent.com');
// Enter your Client Secrect
$client->setClientSecret('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');
// Enter the Redirect URL
$client->setRedirectUri('http://localhost/son/testapi/login.php');
