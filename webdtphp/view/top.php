...
$get_user = mysqli_query($db_connection, "SELECT * FROM `nguoidung` WHERE `google_id`='$id'");
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li>
        <img class="images" src="<?php echo $user['profile_image']; ?>" alt="<?php echo $user['hoten']; ?>" >
        </li>
      <li>
      <h4>Xin chào! <?php echo $user['hoten']; ?></h4>
